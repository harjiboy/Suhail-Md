...
global.readmessagefrom = process.env.READ_MESSAGE_FROM || "2349158455906,923xxxxxxxx";


//========================= [ AUTO SAVE & READ STATUS ] =========================\\
global.read_status = process.env.AUTO_READ_STATUS || "false"
global.save_status = process.env.AUTO_SAVE_STATUS || "false"
global.save_status_from =  process.env.SAVE_STATUS_FROM  || "2349158455906,923xxxxxxxx";
global.read_status_from =  process.env.READ_STATUS_FROM  ||  "2349158455906,923xxxxxxxx";
...
module.exports = {
  ...
  botname : process.env.BOT_NAME  || "fhëmzy❤️",
